...
exports.seed = (knex) => {
  return knex('users').insert([
    { id: 10100, name: 'User #3', mail: 'user3@mail.com', password: '$2a$10$T7D.z0vLZRXY1kD8FAUIZeSYgA8OEzf.HTl.Q5ZWjro0x3JCOkclC' },
    { id: 10101, name: 'User #4', mail: 'user4@mail.com', password: '$2a$10$T7D.z0vLZRXY1kD8FAUIZeSYgA8OEzf.HTl.Q5ZWjro0x3JCOkclC' },
    { id: 10102, name: 'User #5', mail: 'user5@mail.com', password: '$2a$10$T7D.z0vLZRXY1kD8FAUIZeSYgA8OEzf.HTl.Q5ZWjro0x3JCOkclC' },
  ])
